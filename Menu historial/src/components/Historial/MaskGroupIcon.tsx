...
const MaskGroupIcon = (props: SVGProps<SVGSVGElement>) => (
  <svg preserveAspectRatio='none' viewBox='0 0 342 275' fill='none' xmlns='http://www.w3.org/2000/svg' {...props}>
    ...
    <g mask='url(#mask0_69_8312)'>
      ...
      />
      <path
        d='M28 177.16C5.60293 182.625 -9 223.16 -9 223.16V292H351V132.16C351 132.16 334.414 116.342 321 115.16C301.039 113.401 297.537 138.705 278 143.16C265.435 146.025 256.027 136.49 245 143.16C229.596 152.477 210.304 139.187 202 155.16C191.552 175.257 215.209 223.712 193 228.16C155.55 235.66 157.021 180.636 134 150.16C118.37 129.469 118.48 88.6072 94 97.1601C73.4799 104.329 88.9797 132.023 77 150.16C68.9324 162.374 64.9816 172.825 51 177.16C42.4208 179.82 36.7261 175.031 28 177.16Z'
        fill='url(#paint0_linear_69_8312)'
        stroke='#8BD9E9'
        strokeWidth={2}
      />
    </g>
    <defs>
      <linearGradient id='paint0_linear_69_8312' x1={171} y1={96} x2={171} y2={292} gradientUnits='userSpaceOnUse'>
        <stop stopColor='#8BD9E9' />
        <stop offset={1} stopColor='#8BD9E9' stopOpacity={0} />
      </linearGradient>
    </defs>
  </svg>
);
